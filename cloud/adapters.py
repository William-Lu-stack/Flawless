...
DEFAULT_ADAPTERS = [
    ...
    CloudAdapterSpec("virtualization-platform", "virtualization", "通用虚拟化 / VM 平台", False, ["virtual-machine", "host", "network", "storage", "snapshot", "topology"], "secret-ref-or-service-account", [], "datacenter/cluster/resource-pool", "read-only discovery + typed action + human approval"),
