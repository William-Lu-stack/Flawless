...
| 顺序 | 组件 | 国内公开镜像 | 私库建议目标 |
|---|---|---|---|
| 1 | Web、API、MCP、全部 Agent、CMDB | `ghcr.dockerproxy.net/your-org/cisre:5.4.0` | `registry.example.com/k8s-agent:5.4.0` |
| 2 | 审批后的节点命令执行器 | `ghcr.dockerproxy.net/your-org/cisre-node-exec:1.36` | `registry.example.com/k8s-agent-node-exec:1.36` |
